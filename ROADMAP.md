...
- [ ] Invitations and linked-user management
...
After the QR milestone:

- Model/controller/service suite: 54 tests, 149 assertions, all passing.
- Headless-Chrome system suite: 4 tests, 25 assertions, all passing.
